...
function MostrarUsuarios(datos: any, lado: string) 
{
    ...
    datos.forEach(function (element: { correo: string; nombre: string; apellido: string; perfil: string; foto: string; }) {
        html += '<tr>';
...
function MostrarAutos(datos: any, lado:string) 
{
    ...
    datos.forEach((element: { marca: any; color: any; modelo: any; precio: any; id: any; }) => {
        html += '<tr>';
